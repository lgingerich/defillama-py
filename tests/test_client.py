...
ADDRESSES = ['0x02f7bd798e765369a9d204e9095b2a526ef01667', '0xEf1c6E67703c7BD7107eed8303Fbe6EC2554BF6B']
BRIDGE_IDS = ['1', '2']
CHAINS = ['arbitrum', 'ethereum', 'zksync era']
COINS = ['ethereum:0xdF574c24545E5FfEcb9a659c229253D4111d87e1', 'bsc:0x762539b45a1dcce3d36d080f74d1aed37844b878']
...
VOLUME_PARAMS = [
    ...
    {"excludeTotalDataChart": True, "excludeTotalDataChartBreakdown": False, "dataType": "dailyVolume"},
    ...
    {"excludeTotalDataChart": True, "excludeTotalDataChartBreakdown": True, "dataType": "totalVolume"},
    {"excludeTotalDataChart": True, "excludeTotalDataChartBreakdown": False, "dataType": "totalVolume"},
...
def test_get_chain_perps_volume(chains, params, raw):
    ...
    wrapper_instance = Llama()  # Adjust if you need specific arguments for initialization
    ...
    if raw is False and params['excludeTotalDataChart'] == params['excludeTotalDataChartBreakdown']:
        with pytest.raises(ValueError, match=r"Both excludeTotalDataChart and excludeTotalDataChartBreakdown cannot have the same value \(either both True or both False\) if raw = False\."):
            wrapper_instance.get_chain_perps_volume(chains, params, raw)
        return
